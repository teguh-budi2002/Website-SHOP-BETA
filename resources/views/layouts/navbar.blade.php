<div class="flex justify-between items-center">
    ...
    <div class="menu flex-shrink">
        <ul class="flex items-center space-x-4">
            <li>
                <a href="/"
                    class="text-lg text-blue-500 border-2 border-blue-500 p-1 rounded-md font-semibold uppercase flex items-center">
            ...
            <li>
                <a href="#menuSection" class="text-lg text-blue-500 font-semibold uppercase">Menu</a>
            </li>
            <li>
                <a href="#aboutWarung" class="text-lg text-blue-500 font-semibold uppercase">tentang kami</a>
            </li>
        </ul>
    </div>
